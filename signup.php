         ...
         && !empty($_POST["confirm_password"]) && !empty($_POST["allow"]))
    {
        ...
        if (count($error) == 0) {
            ...
            if (mysqli_query($conn, $query)) {
                ...
                echo $error[] = "Errore di connessione al Database";
            }
        }
...
<html>
    <head>
        ...
        <title>Iscriviti - CinemaUniverse</title>
    </head>
    <body>
        <div id="logo">
            CinemaUniverse
        ...
        <section class="main_right">
            ...
            <form name='signup' method='post' enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="allow"> 
                    ...
                    <label for='allow'>Accetto i termini e condizioni d'uso di CinemaUniverse.</label>
                </div>
                <?php if(isset($error)) {
